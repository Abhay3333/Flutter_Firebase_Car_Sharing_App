...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              Positioned.fill(
                child: GoogleMap(
                  ...
                  polylines: _polyline ?? Set<Polyline>(),
  ...
  void drawPolyline(String placeId) {
    ...
    _polyline.add(Polyline(
      ...
      color: Color.fromARGB(255, 26, 162, 230), // color of polyline
      width: 5,
    ));
  }
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              ...
              // Check if markers set is not empty before trying to remove a marker
